...
<div class="container">
    <div class="row"><h4>Rekap Dinas Pendidikan dan Kebudayaan & Dinas Kesehatan</h4></div>
    <div class="row">
        <div class="wrapp-icon" onclick="cetak_rekap('golongan.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/army-icon.png" />
            </div>
            <div class="wrapp-keterangan">
        ...
        <div class="wrapp-icon" onclick="cetak_rekap('rekapeselon.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/eselon.jpg" />
            </div>
            <div class="wrapp-keterangan">
        ...
        <div class="wrapp-icon" onclick="cetak_rekap('rekappddk.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/graduation.png" />
            </div>
            <div class="wrapp-keterangan">
        ...
        <div class="wrapp-icon" onclick="cetak_rekap('rekapagama.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/kcmdf.png" />
            </div>
            <div class="wrapp-keterangan">
        ...
        <div class="wrapp-icon" onclick="cetak_rekap('rekapumur.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/grafik.png" />
            </div>
            <div class="wrapp-keterangan">
...
<div class="container">
    <div class="row">
        <div class="wrapp-icon" onclick="cetak_rekap('golongan_per_jekel.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/army-icon.png" />
            </div>
            <div class="wrapp-keterangan">
        ...
        <div class="wrapp-icon" onclick="cetak_rekap('rekapeselon_per_jekel.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/eselon.jpg" />
            </div>
            <div class="wrapp-keterangan">
        ...
        <div class="wrapp-icon" onclick="cetak_rekap('rekapdidik.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/kexi.png" />
            </div>
            <div class="wrapp-keterangan">
        ...
        <div class="wrapp-icon" onclick="cetak_rekap('rekapagama_per_jekel.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/kcmdf.png" />
            </div>
            <div class="wrapp-keterangan">
        ...
        <div class="wrapp-icon" onclick="cetak_rekap('rekapumur_per_jekel.php?uk[]=04&uk[]=07');">
            <div class="wrapp-image">
                <img src="./images/cpanel/grafik.png" />
            </div>
            <div class="wrapp-keterangan">
