...
<h4 class="title">NOMINATIF</h4>
      <table width="100%">
        ...
        <form name="nominatif1" action="?sid=<?=$sid?>&do=nominatif" method="post">
          <tr> 
          <td width="15%" align="left" height="12">Golongan:</td>
...
&nbsp;&nbsp;
        ...
        <tr> 
          ...
          <td width="610" align="left">
            <select name="jabatan" id="jabatan" class="form-control-static" onchange="nominatif1.submit();">
	...
	<? if ($jabatan=='2') { ?>
        <tr> 
          ...
          <td width="610" align="left">
            <select name="jabfung" id="jabfung" class="form-control-static">
	...
	<? } ?>
        <tr>
          ...
          <td width="610" align="left">
            <select name="diklat" id="diklat" class="form-control-static">
        ...
        <tr> 
          ...
          <td width="610" align="left">
            <select name="agama" id="agama" class="form-control-static">
        ...
        <tr> 
          ...
          <td width="610" align="left">
            <select name="dik" id="dik" class="form-control-static" onchange="nominatif1.submit();">
	...
	<? if ($dik!='all') { ?>
        <tr> 
          ...
          <td width="610" align="left">
            <select name="jur" id="jur" class="form-control-static">
              <option value="">Semua</option>
		<?
	...
	<? } ?>
        <tr>
          <td>Unit Kerja:</td>
          <td>
            <select name="uk" id="uk" class="form-control-static" onchange="nominatif1.submit();">
...
<? if ($hasupt) { ?>
        <tr>
          <td>Induk/UPT:</td>
          <td>
            <select name="subuk" id="subuk" class="form-control-static">
            <option value="all">Semua</option>
