    ...
    <tbody>
        ...
        while($row=mysql_fetch_array($r)) {
              ...
              <tr class="<?= ($no%2===0)?'even':'odd' ?>">
                ...
                <td><button type="button" onclick="load_detail('include/rekap-skp-detail.php?sid=<?=$sid?>&do=cari&nip=<?=$row[B_02]?>&cari=NIP');" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> Detail</button></td>
              </tr>
                <?
        }
        ?>
