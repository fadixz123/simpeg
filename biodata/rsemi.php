...
<script type="text/javascript">
    ...
    function add_new_row_rsemi(val) {
    ...
    function save_data_rsemi() {
        ...
        $.ajax({
            type: 'POST',
            url: 'biodata/save-data.php?save=rsemi',
            data: $('#rsemi_form').serialize(),
            dataType: 'json',
            beforeSend: function() {
                show_ajax_indicator();
            },
...
<form id="rsemi_form" method="post">
...
<table width="100%" class="table table-condensed table-bordered table-hover no-margin" id="rsemi">
    <thead>
        <tr>
            <th width="3%">No</th>
            <th width="15%">NAMA</th>
...
?>   
  ...
  <tr bgcolor="<? echo $warnarow2; ?>">
    <td width="586" colspan="11"><b>Jumlah Riwayat yang Akan Ditambahkan :</b>&nbsp;
        <select name="jmltambah" onchange="add_new_row_rsemi(this.value);" style="width: 100px;">
            <option value="">-</option>
        ...
        <button type="button" class="btn btn-primary" onclick="save_data_rsemi(); return false;"><i class="fa fa-save"></i> Simpan</button>
    </td>
  </tr>
  <tr>
