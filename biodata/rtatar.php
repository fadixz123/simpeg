...
<script type="text/javascript">
    ...
    function add_new_row_rtatar(val) {
    ...
    function save_data_rtatar() {
        ...
        $.ajax({
            type: 'POST',
            url: 'biodata/save-data.php?save=rtatar',
            data: $('#rtatar_form').serialize(),
            dataType: 'json',
            beforeSend: function() {
                show_ajax_indicator();
            },
...
<form id="rtatar_form" method="post">
...
<table width="100%" class="table table-condensed table-bordered table-hover no-margin" id="rtatar">
    <thead>
        <tr>
            <th width="3%">No</th>
            <th width="15%">NAMA</th>
            ...
            <th width="10%">NO. SRTFIKAT<br>
            <th width="7%">TGL&nbsp;SRTFIKAT</th>
            <th width="2%"></th>
        </tr>
    </thead>
    <tbody>
...
?>   
  ...
  <tr bgcolor="<? echo $warnarow2; ?>">
    <td width="586" colspan="11"><b>Jumlah Riwayat yang Akan Ditambahkan :</b>&nbsp;
        <select name="jmltambah" onchange="add_new_row_rtatar(this.value);" style="width: 100px;">
            <option value="">-</option>
        ...
        <button type="button" class="btn btn-primary" onclick="save_data_rtatar(); return false;"><i class="fa fa-save"></i> Simpan</button>
    </td>
  </tr>
  <tr>
